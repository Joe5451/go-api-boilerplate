...
// Source: internal/application/port/out/book_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/application/port/out/book_repository.go -destination=mocks/mock_book_repository.go -package=mocks
//
